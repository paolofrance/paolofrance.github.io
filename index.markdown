...
I am currently a researcher at [Istituto Dalle Molle di studi sull'intelligenza artificiale (IDSIA-USI-SUPSI)](https://www.idsia.usi-supsi.ch/), in the group of Prof. Loris Roveda.
...
During my studies, I had the opportunity to work on my master thesis project at the  [IBM Almaden Research Center](https://research.ibm.com/labs/almaden) in San Jos&eacute;, California.
...
I was involved in the [H2020 EURECA project](https://cordis.europa.eu/project/id/649972) (2018-2020), aiming to automatize the assembly of the airplane's interior. 
...
There, I worked on developing control for physical Human-Robot Interaction (pHRI). The main topic addressed were modeling human behavior, modeling interaction with a Game-Theoretic framework, and the dynamic leader-follower role arbitration between human and robot.
